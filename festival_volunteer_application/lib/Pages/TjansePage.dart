        ...
        return const Scaffold(
          ...
          Expanded(
            ...
            child: ExpandedDialogTile(
                title: 'Fedt at du vil hjælpe til!!', content: 'Velkommen til "Tjanse-siden"! Herunder vil du finde information omkring din tjans.', route: '/tjanser'),
          ),
          Expanded(
            flex: 1,
            child: ExpandedDialogTile(
                title: '(DIN VAGT)', content: 'Du har fået tjansen (XXX), som indebærer (XXX). Du skal møde til tjansen kl (XXX)', route: '/tjanser'),
          ),      
                ], 
            ),
        );
